...
class Emplacement(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        super().__init__()
        self.image = pygame.image.load("assets/pomme_dore.bmp")
...
image_test = pygame.image.load("assets/orange.bmp")
fruits_dict = {
    "cerise": pygame.image.load("assets/cerise.bmp"),
    "ananas": pygame.image.load("assets/ananas.bmp"),
    "orange": pygame.image.load("assets/orange.bmp"),
    "pasteque": pygame.image.load("assets/pasteque.bmp"),
    "pomme_dore": pygame.image.load("assets/pomme_dore.bmp"),
}
...
fond = pygame.image.load("assets/slot.bmp")
